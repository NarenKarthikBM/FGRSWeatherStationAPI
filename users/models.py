...
class UserAccessTokens(models.Model):
    """This model stores user's access tokens
    Returns:
        class: details of user's access tokens
    """
...
class UserAccessRequests(models.Model):
    """This model stores user access requests
    Returns:
        class: details of user access requests
    """
    ...
    approved = models.BooleanField(_("approved"), help_text="Approved", default=False)
    permissions_requested = models.JSONField(
    ...
    approved_at = models.DateTimeField(
        _("approved at"), help_text="Approved At", null=True, blank=True
    )
    ...
    def __str__(self):
        return f"{self.user.email} - Access Request"
